(function () { 
  ...
  $("#chatInput").keyup(function(e) { 
    if (e.keyCode === 13) {  
      return readText(document.getElementById('textPelotita').value);
    }
  })
    ...
    $("#text").change(function(e) {  
     { 
      ...
      //Busquedas-----------------------------------
      mensaje=$("#text").val().toLowerCase();
      if( mensaje.includes('ver video')){
        var porcion = mensaje.substring(9);
